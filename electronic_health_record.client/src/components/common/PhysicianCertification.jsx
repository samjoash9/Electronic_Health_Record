...
export default function PhysicianCertification({ data, onChange }) {
            ...
            <div className="p-4 bg-white grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col space-y-5 justify-center">
                    <div>
                        ...
                        <input type="text" value={physicianName} onChange={(e) => notifyParent('physicianName', e.target.value)} placeholder="e.g. Dr. Juan Dela Cruz" className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-teal-500 focus:outline-none text-sm transition-shadow text-gray-700" />
                    </div>
                    <div>
                        ...
                        <input type="text" value={prcLicense} onChange={(e) => notifyParent('prcLicense', e.target.value)} placeholder="0000000" className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-teal-500 focus:outline-none text-sm transition-shadow text-gray-700" />
                    </div>
                </div>
