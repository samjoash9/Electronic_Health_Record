            ...
            <div className="p-4 bg-white grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <div className="flex items-center">
                        <input
                            ...
                            placeholder="0.0"
                        />
                        <span className="bg-gray-100 border border-l-0 border-gray-300 p-2 rounded-r-md text-gray-500 text-sm px-3">kg</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center">
                        <input
                            ...
                            placeholder="0.0"
                        />
                        <span className="bg-gray-100 border border-l-0 border-gray-300 p-2 rounded-r-md text-gray-500 text-sm px-3">cm</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`w-full p-2 border border-gray-300 rounded-md bg-gray-50 ${getBmiTextColor()}`}
                        disabled
                    />
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center border border-gray-300 rounded-md overflow-hidden bg-white">
                        <input type="number" value={bpSys} onChange={(e) => setBpSys(e.target.value)} className="w-full p-2 text-center text-sm" placeholder="Sys" />
                        <span className="text-gray-300">/</span>
                        <input type="number" value={bpDia} onChange={(e) => setBpDia(e.target.value)} className="w-full p-2 text-center text-sm" placeholder="Dia" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center">
                        <input type="number" step="0.1" value={temp} onChange={(e) => setTemp(e.target.value)} className="w-full p-2 border border-gray-300 rounded-l-md text-sm" placeholder="0.0" />
                        <span className="bg-gray-100 border border-l-0 border-gray-300 p-2 rounded-r-md text-gray-500 text-sm px-3">°C</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center">
                        <input type="number" value={heartRate} onChange={(e) => setHeartRate(e.target.value)} className="w-full p-2 border border-gray-300 rounded-l-md text-sm" placeholder="00" />
                        <span className="bg-gray-100 border border-l-0 border-gray-300 p-2 rounded-r-md text-gray-500 text-sm px-2">bpm</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center">
                        <input type="number" value={respRate} onChange={(e) => setRespRate(e.target.value)} className="w-full p-2 border border-gray-300 rounded-l-md text-sm" placeholder="00" />
                        <span className="bg-gray-100 border border-l-0 border-gray-300 p-2 rounded-r-md text-gray-500 text-sm px-2">bpm</span>
                    </div>
                </div>
            </div>
