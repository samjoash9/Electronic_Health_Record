...
export default function RecommendedDiagnosticTest({ data, onChange }) {
    const diagnosticTest = data?.recommendedDiagnosticTest || '';
    const impression = data?.impressionClinical || '';
    const management = data?.managementTreatment || '';
            ...
            <div className="p-4 bg-white space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div className="border border-gray-300 rounded overflow-hidden focus-within:ring-2 focus-within:ring-teal-500 transition-all">
                            ...
                            <textarea
                                ...
                                onChange={(e) => handleTextChange('recommendedDiagnosticTest', e.target.value)}
                                className="w-full p-2 h-24 focus:outline-none text-sm resize-y text-gray-700"
                    ...
                    <div className="flex flex-col">
                        ...
                        <textarea
                            value={impression}
                            onChange={(e) => handleTextChange('impressionClinical', e.target.value)}
                            className="w-full flex-1 p-2 border border-gray-300 rounded focus:ring-2 focus:ring-teal-500 focus:outline-none text-sm resize-y min-h-[96px] text-gray-700 transition-all"
                ...
                <div>
                    ...
                    <textarea
                        value={management}
                        onChange={(e) => handleTextChange('managementTreatment', e.target.value)}
                        className="w-full p-2 h-20 border border-gray-300 rounded focus:ring-2 focus:ring-teal-500 focus:outline-none text-sm resize-y text-gray-700 transition-all"
