...
namespace Electronic_Health_Record.Server.Data.Migrations
{
    ...
    [Migration("20260913131346_AddBillingAndChargeCatalog")]
    partial class AddBillingAndChargeCatalog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Electronic_Health_Record.Server.Models.BillingSettings", b =>
                {
                    b.Property<int>("BillingSettingsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BillingSettingsID"));

                    b.Property<decimal>("DefaultAllotment")
                        .HasPrecision(12, 2)
                    ...
                    b.HasKey("BillingSettingsID");

                    b.HasIndex("UpdatedByAdminID");

                    b.ToTable("BillingSettings", null, t =>
                        {
                    ...
                    b.HasData(
                        new
                        {
                            BillingSettingsID = 1,
                            DefaultAllotment = 0m,
                            UpdatedAt = new DateTime(2026, 9, 13, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });

            modelBuilder.Entity("Electronic_Health_Record.Server.Models.ChargeItem", b =>
                {
                    b.Property<int>("ChargeItemID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ChargeItemID"));
                    ...
                    b.HasIndex("ItemType", "IsActive", "DisplayOrder")
                        .HasDatabaseName("IX_ChargeItem_ItemType_IsActive_DisplayOrder");

                    b.ToTable("ChargeItem", null, t =>
                        {
            ...
            modelBuilder.Entity("Electronic_Health_Record.Server.Models.FormBilling", b =>
                {
                    b.Property<int>("FormBillingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FormBillingID"));

                    b.Property<decimal>("AllotmentSnapshot")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)");
                    ...
                    b.ToTable("FormBilling", null, t =>
                        {
                            t.HasCheckConstraint("CK_FormBilling_DeductedIsApproved", "Status <> 'Deducted' OR (TotalCharged IS NOT NULL AND ApprovedByAdminID IS NOT NULL AND ApprovedAt IS NOT NULL)");
                    ...
                    b.ToTable("PatientAccount", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_PatientAccount_MustChangePassword", "MustChangePassword = 0 OR PasswordHash IS NOT NULL");
                        });
                });
                    ...
                    b.ToTable("Physician", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Physician_Station", "[Station] IN (3, 4, 5)");
                        });
                });
            ...
            modelBuilder.Entity("Electronic_Health_Record.Server.Models.WellnessFormCharge", b =>
                {
                    ...
                    b.HasIndex("FormID")
                        .HasDatabaseName("IX_WellnessFormCharge_FormID");

                    b.ToTable("WellnessFormCharge", null, t =>
                        {
            ...
            modelBuilder.Entity("Electronic_Health_Record.Server.Models.WellnessFormCharge", b =>
                {
                    b.HasOne("Electronic_Health_Record.Server.Models.ChargeItem", null)
                        .WithMany()
