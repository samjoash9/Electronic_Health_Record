...
namespace Electronic_Health_Record.Server.Data.Migrations
{
    ...
    [Migration("20260902022428_AddActivityLog")]
            ...
            modelBuilder.Entity("Electronic_Health_Record.Server.Models.Physician", b =>
                {
                    ...
                    b.ToTable("Physician", null, t =>
                        {
                            t.HasCheckConstraint("CK_Physician_CredentialSet", "([Email] IS NULL AND [PasswordHash] IS NULL) OR ([Email] IS NOT NULL AND [PasswordHash] IS NOT NULL)");
                        });
                });
